    ...
    <div id="content">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mt-2">
            <div class="col-sm-6">
              <h3 class="m-0 text-dark">Verifikasi Pendaftaran</h3>
            </div><!-- /.col -->
            <div class="col-sm-6">
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header d-flex p-0">
                <h5 class="card-title p-3">Data Pendaftaran</h5>
              </div>
              ...
              <div class="col-12 mb-5 mt-5">
                <table id="example" class="table table-striped table-bordered text-center" style="width:100% ">
                  ...
                  <tbody>
                    <?php 
                        $tampil = mysqli_query($conn,"SELECT * FROM pendaftaran");
                    ...
                    <tr>
                      ...
                      <td class="text-center">
                        <a href="accept_user.php?id=<?= $data['id_pendaftaran'];?>">
                          <button type="submit" class="btn btn-success">Accept</button>
                        </a>
                        <a href="reject_user.php?id=<?= $data['id_pendaftaran'];?>">

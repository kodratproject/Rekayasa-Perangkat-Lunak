          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header d-flex p-0">
                <h5 class="card-title p-3">List Artikel</h5>
              </div>
              <div class="col-12 mt-2 mb-5 ">

                <table id="example" class="table table-striped table-bordered text-center mt-5" style="width:100% ">
                  <thead class="">
                    <tr>
                      <th></th>
                      <th>NO</th>
                  ...
                  <tbody>
                    <?php 
                    $i=0;
                    $tampil = mysqli_query($conn,"SELECT * FROM news");
                    
                    while($data = mysqli_fetch_array($tampil)) :
                    $id = $data['id_user'];
                    $penulis = query("SELECT nama FROM user WHERE id_user ='$id'");
                ?>
                    <tr>
                      <?php $i++?>
                      <td><input type="checkbox" name="<?= $data['id_post'];?>"></td>
                      <td><?= $i;?></td>
                      <td>
                        <a href="" class="text-primary link-text">
                          <?= $data['judul'];?>
                        </a>
                      </td>
                      <td>
